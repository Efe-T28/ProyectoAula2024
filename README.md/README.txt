...
- Backup de la base de datos: El respaldo está disponible en la carpeta `backup`. Puedes descargarlo directamente en (backup/mi-base-de-datos.bak).
...
- Nota: Si tienes problemas para visualizar correctamente la aplicación al ejecutarla, verifica la configuración de tu pantalla:
  ...
  3. En el apartado de "Escala y diseño", ajusta la escala al "125%" o al "100%".
